...
namespace Stage2
{
	...
	constexpr int kLadder4Y = Game::kScreenHeight - 820;
	constexpr int kLadderBottom4X = kLadder4X + 10;
	constexpr int kLadderBottom4Y = kLadder4Y + 150;
